<template>
    ...
    <div class="modal fade" style="overflow-y: scroll;" tabindex="-1" :class="{'mostrar':modal}" role="dialog" aria-labelledby="myModalLabel"  aria-hidden="true">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <barcode :value="codigo" :options="{format:'EAN-16'}">
                                    Generando Codigo barras
                                </barcode>
                            </div>
                        </div>
                        <div class="form-group row">
